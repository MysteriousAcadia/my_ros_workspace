...
// {'beginner_tutorials': ['/home/notanshuman/catkin_ws/src/beginner_tutorials/msg'], 'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg']}
...
struct MD5Sum< ::beginner_tutorials::AddTwoIntsResponse_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x12c4325853b176c5ULL;
  static const uint64_t static_value2 = 0x32a53ae9b61210bcULL;
};
...
struct Printer< ::beginner_tutorials::AddTwoIntsResponse_<ContainerAllocator> >
{
  ...
  {
    s << indent << "result1: ";
    Printer<int64_t>::stream(s, indent + "  ", v.result1);
    s << indent << "result2: ";
