...
class AddTwoIntsResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.int64(obj.result1, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.result1 = _deserializer.int64(buffer, bufferOffset);
  ...
  static md5sum() {
    //Returns md5sum for a message object
    return '12c4325853b176c532a53ae9b61210bc';
  }
...
module.exports = {
  ...
  md5sum() { return '0c806992ffbffb2d16d47726216e0735'; },
